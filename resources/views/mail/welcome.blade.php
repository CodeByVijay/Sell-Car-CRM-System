...
<head>
    ...
    <title>Sell Car - Welcome Email</title>
    <style type="text/css">
                                ...
                                <tr>
                                    <td align="center" class="" valign="top">
                                        ...
                                        <table bgcolor="#fff" cellpadding="0" cellspacing="0" class=""
                                            style="margin: 0 auto; width: 100%; margin-top: 100px; margin-bottom: 30px">
                                            <tbody style="margin-top: 15px;">
                                                ...
                                                <tr class="">
                                                    <td class="headline">Welcome to Sell Car Company!</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <center class="">
                                                                ...
                                                                <tbody class="">
                                                                    <tr class="">
                                                                        <td class=""
                                                                            ...
                                                                            <br><br>
                                                                            A Car management application that helps you
                                                                            manage car leads with ease and efficiency.
                                                                            <br><br>
                                                                            You have successfully been registered to use
                                                                            Sell Car CRM as a <em>Managment
                                                                                Employee</em><br>
                                                                            <br>
