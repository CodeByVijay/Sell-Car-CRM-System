                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding-top: 24px;">
                                                    <img src="{{ asset('admin/vendors/images/logo.svg') }}"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    Please tap the button below to choose a new password. Link expired within 30 minutes
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a data-click-track-id="37" href="{{route('reset_password',$token)}}"
